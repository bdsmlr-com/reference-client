...
import { maybeTrackReturnVisit } from './services/return-visit.js';
...
export class AppRoot extends LitElement {
  ...
  private _router = new Router(this, [
    ...
    { path: '/social/:blogname/siblings', render: ({ blogname }) => html`<view-social .blog=${this.resolveRouteBlogName(blogname || '')} .initialTab=${'siblings'}></view-social>` },
